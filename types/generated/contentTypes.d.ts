...
export interface ApiAttendaceAttendace extends Schema.CollectionType {
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    thubnail: Attribute.Media & Attribute.Required;
